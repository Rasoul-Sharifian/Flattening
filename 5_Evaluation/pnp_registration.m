...
cameraParams = cameraParameters('IntrinsicMatrix',camIntrinsics.IntrinsicMatrix,'RadialDistortion',camIntrinsics.RadialDistortion,'TangentialDistortion',camIntrinsics.TangentialDistortion);
...
%     imgName = 'tumor1_from_trocar1_to_camera';
    ...
    m=1;
    A1=[k(1)/m 0 k(7)/m 0; 0 k(1)/m k(8)/m 0; 0 0 1 0];
    A1 = A1(:,1:3);

%     [R2,T2]=efficient_pnp(x3d_h',x2d_h',A1);

    K=[k(1)/m 0 k(7)/m; 0 k(1)/m k(8)/m; 0 0 1];
