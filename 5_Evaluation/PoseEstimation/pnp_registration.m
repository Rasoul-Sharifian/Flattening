...
imgPath =  'color_frame_325.png';%['t2_k1_c.JPG'];
...
%     [R2,T2]=efficient_pnp(x3d_h',x2d_h',A1);
    ...
    filenameNoExt = 'color_frame_325';%'t2_k1_c';
    posesPath = 'posesPath';
    ...
    msh = read3dMesh(['deformedMesh00.obj']);
    M = [R,T];
    M(4,4) = 1;
